...
//moved to BSP.h file static uint32_t SubsystemFrequency = 3000000; // cycles/second
...
// Output: none
//moved to BSP.h file static uint16_t PWMCycles;         // number of PWM cycles per period
